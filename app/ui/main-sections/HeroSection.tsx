...
const HeroSection = () => (
    <div className="overflow-hidden bg-white py-18 sm:py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          ...
          <Image
              ...
              width={1432}
              height={847}
              className="hidden md:block w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-slate-400/10 sm:w-[57rem] md:-ml-4 lg:-ml-0"
            />
        </div>
      </div>
    </div>
